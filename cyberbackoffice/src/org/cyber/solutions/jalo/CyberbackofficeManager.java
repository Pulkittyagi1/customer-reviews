 ...
 */
package org.cyber.solutions.jalo;
...
import org.cyber.solutions.constants.CyberbackofficeConstants;
 ...
 */
public class CyberbackofficeManager extends GeneratedCyberbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CyberbackofficeManager.class.getName());
	 ...
	 */
	public static CyberbackofficeManager getInstance()
	{
		return (CyberbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyberbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyberbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CyberbackofficeManager called.");
		}
	}
